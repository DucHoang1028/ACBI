...
const labels:Record<string,string>={revenue:'Doanh thu',sales_growth:'Tăng trưởng doanh thu',production_output:'Sản lượng',defect_rate:'Tỷ lệ phế phẩm',territory:'Khu vực',sales_territory:'Khu vực',month:'Tháng',product:'Sản phẩm',sample_count:'Số bản ghi',current_revenue:'Doanh thu kỳ này',previous_revenue:'Doanh thu kỳ trước'};
